...
import { Facebook, Twitter, Instagram, GitlabIcon as GitHub, Linkedin } from "lucide-react"
    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center">
          <p className="text-gray-400">&copy; {new Date().getFullYear()} BookingLink. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )

    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-bold mb-4">BookingLink</h3>
            <p className="text-gray-400 mb-4">
              A PHIPA-compliant multi-tenant clinic appointment management platform for healthcare providers.
            </p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center">
          <p className="text-gray-400">
            &copy; {new Date().getFullYear()} BookingLink. All rights reserved. Provided by Marluc Radio Studio.
          </p>
        </div>
      </div>
    </footer>

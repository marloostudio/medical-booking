...
export default function LoginContent({ redirect = "/dashboard" }: { redirect?: string }) {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // This is a demo, so we'll just simulate a login
    setTimeout(() => {
      setLoading(false)
      setError("This is a demo page. In a real implementation, this would authenticate with Firebase and NextAuth.")
    }, 1500)
  }

  const handleGoogleLogin = () => {
    setError("This is a demo page. In a real implementation, this would redirect to Google OAuth.")
  }
        ...
        <div className="w-full max-w-sm mx-auto lg:w-96">
          <div>
            <div className="flex items-center">
              ...
              <h2 className="ml-3 text-2xl font-bold text-gray-900">BookingLink</h2>
            </div>
        ...
        <div className="absolute inset-0 bg-primary-50">
          <div className="relative w-full h-full">
            <Image
              ...
              alt="BookingLink Dashboard Preview"
              fill
